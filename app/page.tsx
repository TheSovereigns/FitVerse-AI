...
function HomeDashboard({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Macro Grid Card */}
      <div className="p-4 md:p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/10 rounded-3xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 shadow-lg dark:shadow-none">
        ...
        <div className="space-y-3">
          {dailyActivity.scannedProducts.length > 0 ? (
            dailyActivity.scannedProducts.slice(0, 3).map((product: any, index: number) => (
              <div key={index} className="flex items-center gap-4 p-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/10 rounded-2xl shadow-sm hover:shadow-md transition-shadow dark:shadow-none">
