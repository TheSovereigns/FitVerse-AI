    ...
    <>
      <Card className="p-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <Badge className="bg-primary/10 text-primary border-primary/20">Mais saudável</Badge>
        </div>
        ...
        <p className="text-xs text-muted-foreground mt-3 text-center">💚 Links podem conter afiliados</p>
      </Card>
