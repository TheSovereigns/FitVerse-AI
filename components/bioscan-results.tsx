  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-6 p-4 bg-black text-zinc-100 rounded-3xl border border-zinc-800/50 shadow-2xl">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-zinc-900/30 border border-zinc-800 backdrop-blur-md p-6 group">
        ...
        <div className="absolute top-0 left-0 w-6 h-6 border-t-2 border-l-2 border-foreground/40 opacity-80" />
        <div className="absolute top-0 right-0 w-6 h-6 border-t-2 border-r-2 border-foreground/40 opacity-80" />
        <div className="absolute bottom-0 left-0 w-6 h-6 border-b-2 border-l-2 border-foreground/40 opacity-80" />
        <div className="absolute bottom-0 right-0 w-6 h-6 border-b-2 border-r-2 border-foreground/40 opacity-80" />

        <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
          <div className="text-center md:text-left space-y-2">
            <Badge variant="outline" className="border-foreground/40 text-foreground bg-foreground/10 px-3 py-1">
              BIO-SCANNER v2.0
            </Badge>
            <div>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-foreground rounded-full blur-2xl opacity-20 animate-pulse" />
            <div className="relative w-24 h-24 rounded-full border-[3px] border-foreground/40 flex flex-col items-center justify-center bg-black/80 shadow-[0_0_30px_rgba(255,255,255,0.3)]">
              <span className="text-4xl font-black text-white leading-none">{score}</span>
              <span className="text-[9px] text-foreground font-bold uppercase tracking-widest mt-1">Score</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3 bg-zinc-900/20 p-4 rounded-2xl border border-zinc-800/50">
        <div className="flex justify-between items-end">
          ...
          <span className="text-foreground font-mono font-bold text-lg">{goalAlignment}%</span>
        </div>
        ...
        <div className="h-3 w-full bg-zinc-900 rounded-full overflow-hidden border border-zinc-800 relative">
           ...
           <div 
             className="h-full bg-foreground shadow-[0_0_10px_rgba(255,255,255,0.6)] relative transition-all duration-1000 ease-out"
