      ...
      <section className="relative w-full overflow-hidden rounded-[2rem] border border-white/10 bg-black/50 p-6 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_28px_90px_rgba(0,0,0,0.32)] backdrop-blur-2xl md:rounded-[2.5rem] md:p-10">
        ...
        <div className="relative mx-auto max-w-xl">
          ...
          <div className="mx-auto mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 py-1.5">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.24em] text-foreground/80">{t("store_coming_soon")}</span>
          </div>
          <h1 className="text-4xl font-black tracking-tight text-foreground md:text-5xl">{t("chatbot_header")}</h1>
          <p className="mx-auto mt-4 max-w-md text-sm font-bold leading-relaxed text-foreground/50 md:text-base">{t("chatbot_disabled_desc")}</p>
          <div className="mx-auto mt-7 inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-white/8 px-4 py-3 text-[10px] font-black uppercase tracking-widest text-foreground/80">
