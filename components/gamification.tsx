...
export function Gamification() {
  ...
  const { currentStreak: streakCurrent, longestStreak: streakLongest } = useStreak()
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="glass border-white/10 rounded-xl p-4 text-center">
                  <p className="text-2xl font-black text-foreground">{userStats.longestStreak}</p>
      ...
      <AnimatePresence>
        {newBadge && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 50 }}
            className="fixed bottom-24 left-1/2 -translate-x-1/2 z-50 glass-strong border-white/20 rounded-2xl p-4 flex items-center gap-3"
          >
            <span className="text-3xl">{newBadge.icon}</span>
            <div>
              <p className="font-black text-foreground">{t("gam_badge_unlocked") || "Badge解锁!"}</p>
