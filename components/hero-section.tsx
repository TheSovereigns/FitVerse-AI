...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center px-4 md:px-6 lg:px-8 xl:px-12 pt-20 pb-16">
      {/* Background Effects */}
      ...
      <div className="relative z-10 max-w-4xl xl:max-w-5xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 lg:gap-8"
        >
          <CTAButton
