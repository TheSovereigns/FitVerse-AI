...
import { ScanLine, User, Calculator, ChefHat, Dumbbell, Loader2, ShoppingBag, Settings, Bot } from "lucide-react"
import { Button } from "@/components/ui/button"

type View = "dashboard" | "result" | "recipes" | "training" | "profile" | "planner" | "settings" | "store" | "chatbot"
...
export default function DashboardPage() {
  ...
  const setUserMetabolicPlan = (plan: any, perfil?: any) => {
    ...
    if (fullPlan) {
      // Salva no localStorage para "memória" entre sessões
