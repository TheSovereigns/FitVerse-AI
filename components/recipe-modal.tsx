    ...
    <Dialog open={true} onOpenChange={(open) => !open && onClose()}>
      ...
      >
        <motion.div
          ...
          className="relative flex h-full flex-col overflow-hidden rounded-[2rem] border border-border bg-black/40 shadow-[inset_0_1px_0_rgba(255,255,255,0.10),0_24px_90px_rgba(0,0,0,0.58)] backdrop-blur-2xl"
        >
          ...
          <ScrollArea className="relative flex-1">
            <div className="space-y-5 p-4 pb-28 md:p-6 md:pb-28">
              ...
              <section className="relative overflow-hidden rounded-[1.75rem] border border-border bg-black/42 p-4 shadow-xl backdrop-blur-2xl md:p-5">
                ...
                <section className="rounded-[1.75rem] border border-border bg-white/10 p-4 shadow-xl backdrop-blur-2xl md:p-5">
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    {recipe.biohackingTips.map((tip, index) => (
                      <div key={`${tip}-${index}`} className="flex items-start gap-3 rounded-2xl border border-border bg-black/28 p-3">
          ...
          <div className="absolute inset-x-0 bottom-0 z-20 border-t border-border bg-black/70 p-4 backdrop-blur-2xl">
            <Button
              onClick={onClose}
