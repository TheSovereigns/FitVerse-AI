...
export function AppButton({
  ...
  const variantStyles = {
    primary: "bg-foreground text-background hover:bg-foreground/80 shadow-lg shadow-primary/30",
    secondary: "bg-white/10 text-foreground hover:bg-white/10 border border-white/10",
    ghost: "bg-transparent text-foreground hover:bg-white/10 border-transparent",
    danger: "bg-red-500 text-white hover:bg-red-600 shadow-lg shadow-red-500/20",
    outline: "glass border-white/10 text-foreground hover:bg-white/10"
  }
  ...
  return (
    ...
    >
      ...
      {comingSoon && (
        <span className="ml-2 text-[10px] bg-foreground/10 px-2 py-0.5 rounded-full">
